...
contract Dao is Ownable {
    ...
    ) Ownable(0x9e267749E478eD528b4A1F40bD600dA5510258Dc) {
    ...
    function joinDao() public payable {
        require(
            msg.value == joinStake,
            "Stake amount should be equal to as specified"
        );
    ...
    function voteProposal(uint256 proposalId, Vote vote) public onlyDaoMember {
        ...
        require(
            idToProposal[proposalId].deadline > block.timestamp,
            "deadline exceeded"
        );
    ...
    function executeProposal(uint256 proposalId) public onlyDaoMember {
        ...
        require(
            !idToProposal[proposalId].executed,
